      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className={`w-full bg-indigo-600 text-white font-bold py-3 rounded-xl shadow-lg transition-all active:scale-[0.98] mt-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-indigo-700'}`}
          >
